  ...
  return (
    <div className="flex flex-col lg:grid lg:grid-cols-12 min-h-screen bg-pink-50">
      ...
      <div className="lg:col-span-9 space-y-6 md:space-y-8 p-4 md:p-6 lg:p-10">
        ...
        <div className="mb-6 bg-white p-4 rounded-xl shadow-sm border-l-4 border-pink-400">
           <h2 className="text-lg font-bold text-pink-700">🌺 Girls Dashboard</h2>
           <p className="text-gray-600 text-sm">Special tracking for your blessed month.</p>
        </div>
