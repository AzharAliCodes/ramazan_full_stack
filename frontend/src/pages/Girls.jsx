...
function Girls() {
  ...
  return (
    <div className="flex flex-col lg:grid lg:grid-cols-12 min-h-screen bg-pink-50">
      {/* Sidebar - could be customized for Girls view later */}
      <Sidebar
      ...
      <div className="lg:col-span-9 space-y-6 md:space-y-8 p-4 md:p-6 lg:p-10">
        ...
        {(() => {
          ...
          return (
            <div className="flex items-center justify-between bg-white p-4 rounded-xl shadow-sm border-l-4 border-pink-400 mb-6">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 bg-gradient-to-br from-pink-500 to-pink-600 rounded-full flex items-center justify-center text-white font-bold text-lg shadow">
                  {userName.charAt(0).toUpperCase()}
                </div>
                <div>
                  <h2 className="text-lg font-bold text-pink-700 flex items-center gap-2">🌺 {userName}</h2>
